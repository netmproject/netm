...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "NetM " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
      {"minpto.com", "dnsseed.minpto.com"},
//    {"netmred.com", "seed.netmred.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. NetM is probably already running."), addrBind.ToString().c_str());
        else
